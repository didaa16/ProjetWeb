<nav class="navbar navbar-expand-lg navbar-dark bg-warning" style="background-color: #feb900; font-family: 'Segoe UI', sans-serif;">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><img src="includes/Logo2PNG.png" alt="Logo" class="navbar-logo" ></a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php 
          if(isset($_SESSION['auth'])){
            ...
            <li class="nav-item">
              <a class="nav-link" href="actions/users/logoutAction.php" style="color: black;">Déconnexion</a>
            </li>
            <?php
          }
        ?>
