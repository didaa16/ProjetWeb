...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/breadcrumbs-bg.jpg');">
      ...
      <h2>club</h2>
      <a href="ajouterclub.php" style="background-color: #f44336; color: white; padding: 8px 12px; border-radius: 3px;">Ajouter club</a>
      ...
      <div class="card">
        ...
        <a style=" background-color: red;" href="supprimerclub.php?idclub=<?php echo $club['idclub'] ; ?>">Supprimer</a>
		
        <a href="modifierclub.php?idclub=<?php echo $club['idclub'] ; ?>">Modifier</a>
      </div>
      <?php
        }
      ?>
