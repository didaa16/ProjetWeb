...
<div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i></i>Nom Produit : <?PHP echo $nom ?></h3>
...
<tr>
<td>Genre Produit</td>
<td><input type="genre" name="genre" value="<?PHP echo $genre ?>"></td>
</tr>
<tr>
<td>Prix  Produit</td>
...
<tr>
<td>Current Image</td>
<td><img src="images/<?php echo $row['img'];?>"   style="width: 150px"></td>
</tr>
<tr>
<td>New Image</td>
